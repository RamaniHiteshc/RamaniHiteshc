...
Version:     1.0
Author:      HCR Software
Author Url:  https://www.hcrsoftware.blogspot.com/
----------------------------------------------- */

/*
<!-- Variable definitions -->
<Variable name="keycolor" description="Main Color" type="color" hideEditor="true" default="$(main.color)" value="#7163cf"/>
...
<Group description="Theme Colors" selector="body">
  <Variable name="main.color" description="Theme Color" type="color" default="#7163cf" value="#7163cf"/>
  <Variable name="dark.color" description="Dark Color" type="color" default="#222222" value="#222222"/>
  <Variable name="main.menu.color" description="Main Menu Color" type="color" default="#fff" value="#ffffff"/>
...
<!-- Extra Variables -->
<Variable name="body.background.color" description="Body background color" hideEditor="true" type="color" default="#f7f8fa"  value="#f7f8fa"/>
<Variable name="head.color" description="Header background color" hideEditor="true" type="color" default="#ffffff"  value="#ffffff"/>
<Variable name="body.background" description="Background" hideEditor="true" type="background" color="$(body.background.color)" default="$(color) url() repeat scroll top left" value="$(color) url() repeat scroll top left"/>
<Variable name="body.link.color" description="Body Link Color" hideEditor="true" type="color" default="$(main.color)"  value="#7163cf"/>
...
<Variable name="posts.icons.color" description="Post icons color" hideEditor="true" type="color" default="$(main.color)"  value="#7163cf"/>
<Variable name="labels.background.color" description="Label background color" hideEditor="true" type="color" default="$(main.color)"  value="#7163cf"/>
...
<!-- Theme Options -->
  <div class='theme-options' style='display:none'>
    <b:section class='sora-panel' id='sora-panel' maxwidgets='1' name='Theme Options' showaddelement='no'>
      ...
      <b:widget id='LinkList70' locked='false' title='Boxed Version' type='LinkList' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
...
<div class='top-left-corner'/>
      <b:section class='header-logo' id='header-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
        <b:widget id='Header1' locked='true' title='Ramani Hitesh iOS Developer (Header)' type='Header' version='2' visible='false'>
          <b:widget-settings>
  ...
  <b:if cond='data:view.isHomepage'> 
    ...
    <div id='intro-wrap'>
      <b:section class='full-height' id='main-intro' maxwidgets='1' name='Main Intro' showaddelement='no'>
        <b:widget id='Image1' locked='true' title='Heyy , I am  Hitesh' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-fYnWv8SJFQo/X9yyc3EwoII/AAAAAAAAbe4/0URdzvXpD2MSoY6dzRpsJOfLa33ARbcYACK4BGAYYCw/s790/pexels-fotografierende-1111597.jpg</b:widget-setting>
            <b:widget-setting name='displayHeight'>527</b:widget-setting>
            <b:widget-setting name='sectionWidth'>790</b:widget-setting>
            <b:widget-setting name='shrinkToFit'>true</b:widget-setting>
            <b:widget-setting name='displayWidth'>790</b:widget-setting>
            <b:widget-setting name='link'>Click More</b:widget-setting>
            <b:widget-setting name='caption'>iOS Developer, Blogger ,Flutter Developer</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
            <b:include name='content'/>
          </b:includable>
            ...
            <div class='widget-content'>
              ...
              <div class='intro-content'>
                ...
                <b:if cond='data:caption'>
                  <span class='intro-snippet' expr:data-text='data:caption'/>
                </b:if>
                <b:if cond='data:link'>
      ...
      <b:section class='main-menu' id='main-menu' maxwidgets='1' name='Main Menu' showaddelement='yes'>
        <b:widget id='LinkList74' locked='true' title='Menu Widget' type='LinkList' version='2' visible='true'>
          <b:widget-settings>
            ...
            <b:widget-setting name='text-0'>My Certificate</b:widget-setting>
            <b:widget-setting name='link-0'>https://ramanihiteshc.blogspot.com/p/my-ios-applications.html?m=1</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
            <b:include name='content'/>
          </b:includable>
...
<div class='author-image-details'>
<div class='author-photo-widget'>
 <b:section class='author-about-image' id='author-about-image' maxwidgets='1' name='Author Image Section' showaddelement='no'>
   <b:widget id='Image150' locked='true' title='Author Image' type='Image' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-N_lmtAAe5WQ/X-roTlE02UI/AAAAAAAAbk4/37zDMoNenxEmbUwrxVvfKiPH4OIFt1eZgCK4BGAYYCw/s1600/IMG_20201218_194121.jpg</b:widget-setting>
       <b:widget-setting name='displayHeight'>947</b:widget-setting>
       <b:widget-setting name='sectionWidth'>310</b:widget-setting>
       <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
       <b:widget-setting name='displayWidth'>802</b:widget-setting>
       <b:widget-setting name='link'>/</b:widget-setting>
       <b:widget-setting name='caption'>/</b:widget-setting>
     </b:widget-settings>
     <b:includable id='main' var='this'>
      <b:include name='content'/>
    </b:includable>
...
<div class='author-details-widget'>
 <b:section class='author-details-wid' id='author-details-wid' maxwidgets='2' name='Author Name &amp; Details' showaddelement='no'>
   <b:widget id='Text4' locked='true' title='Ramani Hitesh' type='Text' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='content'><![CDATA[<span =""  style="font-family:&quot;;">iOS Developer since 2016. I develop iOS &amp; flutter Applications, Web service, and open source technologies. I am very passionate about developing new and innovative things. Writing a new blog post every week related to Mobile development , Swift , XCode . Regular Speaker and workshop host. </span>]]></b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
<span class='hello-txt'>Hello</span>
   ...
   <b:widget id='LinkList79' locked='true' title='Author Details' type='LinkList' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='link-7'>English, Hindi</b:widget-setting>
       <b:widget-setting name='link-5'>Surat, India</b:widget-setting>
       <b:widget-setting name='link-6'>India</b:widget-setting>
       <b:widget-setting name='link-3'>ramanihiteshc@gmail.com</b:widget-setting>
       <b:widget-setting name='link-4'>16 Nov 1994</b:widget-setting>
       <b:widget-setting name='text-1'>Phone</b:widget-setting>
       <b:widget-setting name='text-0'>First Name</b:widget-setting>
       <b:widget-setting name='text-3'>Email</b:widget-setting>
       <b:widget-setting name='text-2'>Last Name</b:widget-setting>
       <b:widget-setting name='text-5'>Address</b:widget-setting>
       <b:widget-setting name='text-4'>Date of Birth</b:widget-setting>
       <b:widget-setting name='text-7'>Languages</b:widget-setting>
       <b:widget-setting name='text-6'>Nationality</b:widget-setting>
       <b:widget-setting name='sorting'>NONE</b:widget-setting>
       <b:widget-setting name='link-1'>+91 82384 19018</b:widget-setting>
       <b:widget-setting name='link-2'>Ramani</b:widget-setting>
       <b:widget-setting name='link-0'>Hitesh</b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
     <b:includable id='content'>
              <div class='widget-content'>
                <ul class='profile-details'>
                  <b:loop values='data:links' var='link'>
                    <li class='profile-list'><span class='author-details-title'><data:link.name/></span><span class='author-details-value'><data:link.target/></span></li>
                  </b:loop>
<div class='clearfix'/>
                </ul>
              </div>
   ...
   <b:widget id='LinkList81' locked='true' title='Author Buttons' type='LinkList' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='sorting'>NONE</b:widget-setting>
       <b:widget-setting name='text-1'><![CDATA[<i class="fa fa-envelope"></i>Contact Me]]></b:widget-setting>
       <b:widget-setting name='link-1'>https://g.page/HCRSoftware?gm</b:widget-setting>
       <b:widget-setting name='text-0'><![CDATA[<i class="fa fa-file-pdf-o"></i>Download Resume]]></b:widget-setting>
       <b:widget-setting name='link-0'>https://drive.google.com/file/d/1O_erZ3wGRPVi4I8mT80MuCwb0F7ksy_n/view</b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
     <b:includable id='content'>
              <div class='widget-content'>
                <ul class='small-button'>
                  <b:loop values='data:links' var='link'>
                    <li><a class='button medium' expr:href='data:link.target'><data:link.name/></a></li>
                  </b:loop>
                </ul>
              </div>
            </b:includable>
...
<b:section id='intro-author-heading' maxwidgets='2' name='Main Author Intro Heading' showaddelement='no'>
  <b:widget id='HTML1' locked='true' title='Something about me' type='HTML' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='content'>I Experienced in UPI Integration, P2P, P2M Transaction. | Hands on experience into BLE wireless device (iBeacon), third party beacon device integration into the mobile app. | Expert in auto layout. | Developed many iOS applications (iPhone/iPad) and are live on App Store. | Experience in building commercial iPhone applications. I Passionate to build applications in iOS from scratch. | Solid knowledge of the full mobile development life cycle Architect and design leading solutions with a strong focus on security, performance, and scalability. | Proficient in Objective C, Swift, XCode IDE, iPhone SDK, Cocoa touch Framework, Interface builder and StoryBoard. | Master in Core Animation which is used to animate the views and other visual elements of an app. I Knowledge of XML parsing, JSON, REST, Maps, SOAP, and SQLite in iPhone. I Deep understanding of data structures and algorithms.
&lt;div class=&quot;small-button&quot;&gt;
&lt;a class=&quot;button medium&quot; href=&quot;https://github.com/Ramani1994&quot;&gt;GitHub&lt;/a&gt;
&lt;a class=&quot;button medium&quot; href=&quot;https://stackoverflow.com/users/5478736/ramani-hitesh&quot;&gt;StackOverflow&lt;/a&gt;
...
&lt;style type=&#39;text/css&#39;&gt;
 ...
 <div class='clearfix'/>
<div class='author-skill-details'>
<b:section class='author-list left-side-widget' id='intro-services-left' maxwidgets='8' name='Author Skills' showaddelement='no'>
  <b:widget id='LinkList80' locked='true' title='Author Skills' type='LinkList' version='2' visible='true'>
    <b:widget-settings>
      <b:widget-setting name='link-7'>35</b:widget-setting>
      <b:widget-setting name='link-5'>85</b:widget-setting>
      <b:widget-setting name='link-6'>76</b:widget-setting>
      <b:widget-setting name='link-3'>83</b:widget-setting>
      <b:widget-setting name='link-4'>70</b:widget-setting>
      <b:widget-setting name='text-1'>Swift</b:widget-setting>
      <b:widget-setting name='text-0'>Objective C</b:widget-setting>
      <b:widget-setting name='text-3'>JSON , XML</b:widget-setting>
      <b:widget-setting name='text-2'>iOS SDK</b:widget-setting>
      <b:widget-setting name='text-5'>Web Services</b:widget-setting>
      <b:widget-setting name='text-4'>Cocoa Touch</b:widget-setting>
      <b:widget-setting name='text-7'>Flutter</b:widget-setting>
      <b:widget-setting name='text-6'>3rd party SDKs</b:widget-setting>
      <b:widget-setting name='sorting'>NONE</b:widget-setting>
      <b:widget-setting name='link-1'>80</b:widget-setting>
      <b:widget-setting name='link-2'>65</b:widget-setting>
      <b:widget-setting name='link-0'>92</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
    <b:includable id='content'>
              <div class='widget-content'>
                <ul class='skills'>
                  <b:loop values='data:links' var='link'>
                    <li class='skill-bar'><span class='skill-name'><data:link.name/></span><span class='skill-perfecnt-val'><data:link.target/></span><span class='skill-full-percent'/><span class='skill-percent' expr:data-percent='data:link.target'/></li>
                  </b:loop>
                </ul>
              </div>
            </b:includable>
 ...
 <b:section class='author-list right-side-widget' id='intro-services-right' maxwidgets='8' name='Author Services' showaddelement='no'>
   <b:widget id='Image21' locked='true' title='Mobile App Development' type='Image' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-6p2jJp25oy0/W1JAGXU11UI/AAAAAAAACdw/-TIjB40wBgw1eBFz4lhzmDgAHdHutt9XwCK4BGAYYCw/s1600/service1.png</b:widget-setting>
       <b:widget-setting name='displayHeight'>70</b:widget-setting>
       <b:widget-setting name='sectionWidth'>790</b:widget-setting>
       <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
       <b:widget-setting name='displayWidth'>70</b:widget-setting>
       <b:widget-setting name='link'>fa-desktop fa-4x</b:widget-setting>
       <b:widget-setting name='caption'>We develop interactive Native and Hybrid mobile apps for Android and iOS by leveraging technologies such as AR/VR, React Native, Xamarin, Cordova, etc.</b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
   ...
   <b:widget id='Image22' locked='true' title='Web development' type='Image' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-P9JKL3gNPLw/W1JALZWqyEI/AAAAAAAACd4/CVUxHZ9ol9cPwqTaR-9Rw9tvWmCmIUoiACK4BGAYYCw/s1600/service2.png</b:widget-setting>
       <b:widget-setting name='displayHeight'>70</b:widget-setting>
       <b:widget-setting name='sectionWidth'>790</b:widget-setting>
       <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
       <b:widget-setting name='displayWidth'>70</b:widget-setting>
       <b:widget-setting name='link'>fa-globe fa-4x</b:widget-setting>
       <b:widget-setting name='caption'><![CDATA[With the help of our highly qualified & experienced developers we deliver highly customized web applications to our clients. We provide web applications of various types such as CMS, eCommerce web portal, and enterprise web development.]]></b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
   ...
   <b:widget id='Image23' locked='true' title='Desktop application' type='Image' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-P9JKL3gNPLw/W1JALZWqyEI/AAAAAAAACd4/CVUxHZ9ol9cPwqTaR-9Rw9tvWmCmIUoiACK4BGAYYCw/s1600/service2.png</b:widget-setting>
       <b:widget-setting name='displayHeight'>70</b:widget-setting>
       <b:widget-setting name='sectionWidth'>790</b:widget-setting>
       <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
       <b:widget-setting name='displayWidth'>70</b:widget-setting>
       <b:widget-setting name='link'>fa-flag fa-4x</b:widget-setting>
       <b:widget-setting name='caption'>We provide both cross-platform as well as platform specific desktop application that would translate your raw software idea into a money-making reality. Our desktop application solutions are of unmatched quality which is enough to outdo any rival.</b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
   ...
   <b:widget id='Image24' locked='true' title='Cloud &amp;amp; DevOps' type='Image' version='2' visible='true'>
     <b:widget-settings>
       <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-P9JKL3gNPLw/W1JALZWqyEI/AAAAAAAACd4/CVUxHZ9ol9cPwqTaR-9Rw9tvWmCmIUoiACK4BGAYYCw/s1600/service2.png</b:widget-setting>
       <b:widget-setting name='displayHeight'>70</b:widget-setting>
       <b:widget-setting name='sectionWidth'>790</b:widget-setting>
       <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
       <b:widget-setting name='displayWidth'>70</b:widget-setting>
       <b:widget-setting name='link'>fa-camera fa-4x</b:widget-setting>
       <b:widget-setting name='caption'><![CDATA[We provide cloud & DevOps consultation to our clients that helps in automation and standardization of the processes which in turn results in better operational efficiency, faster innovation, and improved deployment quality.]]></b:widget-setting>
     </b:widget-settings>
     <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
...
<div class='clearfix'/>
    ...
    <div class='clearfix'/>
     ...
     <div id='testimonial-wrap'>
      <div class='container row'>
        <b:section class='head-text' id='head-text2' maxwidgets='4' name='Headline Text 01' showaddelement='no'>
          <b:widget id='Text2' locked='true' title='My Hobbies &amp;amp; Interests' type='Text' version='2' visible='true'>
            <b:widget-settings>
        ...
        <b:section id='testimonial' maxwidgets='8' name='My Hobbies' showaddelement='no'>
          <b:widget id='Image6' locked='true' title='Biking' type='Image' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-Orl1PzDnnEM/Xx3e1jJPjRI/AAAAAAAAJDQ/Z1skkO8RcOAcIYaL7T_R4RaqKbgKjlvtACK4BGAYYCw/s1600/Biking.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>412</b:widget-setting>
              <b:widget-setting name='sectionWidth'>790</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>640</b:widget-setting>
              <b:widget-setting name='link'>none</b:widget-setting>
              <b:widget-setting name='caption'>none</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
          ...
          <b:widget id='Image7' locked='true' title='Gym' type='Image' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-fdNYfYal-nc/Xx3e-URt7SI/AAAAAAAAJDY/4MgYmJutic8DiugfSGaHdOksC2tiZNo0ACK4BGAYYCw/s1600/Gym.jpg</b:widget-setting>
              <b:widget-setting name='displayHeight'>1200</b:widget-setting>
              <b:widget-setting name='sectionWidth'>790</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
          ...
          <b:widget id='Image8' locked='true' title='Coding' type='Image' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-Z8pjRahKx94/X74HE5gLTFI/AAAAAAAAbXo/L3dJwLtRJ8cqme5NfXff50ZIlK8hSHlrgCK4BGAYYCw/s790/3%2BDifferent%2BWays%2Bto%2BCombine%2BArrays%2Bin%2BJavaScript.jpeg</b:widget-setting>
              <b:widget-setting name='displayHeight'>525</b:widget-setting>
              <b:widget-setting name='sectionWidth'>790</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>true</b:widget-setting>
              <b:widget-setting name='displayWidth'>790</b:widget-setting>
              <b:widget-setting name='link'>none</b:widget-setting>
          ...
          <b:widget id='Image9' locked='true' title='Cooking' type='Image' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-Rv_b8ZMFid0/X74EqJ-iOcI/AAAAAAAAbXc/sH2y6FUXnO84-VXwq3qxq6e-7WUPZED_gCK4BGAYYCw/s1600/Fast%2BThai%2BDishes.jpeg</b:widget-setting>
              <b:widget-setting name='displayHeight'>550</b:widget-setting>
              <b:widget-setting name='sectionWidth'>790</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='displayWidth'>550</b:widget-setting>
              <b:widget-setting name='link'>none</b:widget-setting>
              <b:widget-setting name='caption'>none</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
    ...
    <div id='content-wrapper'>
      ...
      <div id='main-wrapper'>
        ...
        <b:if cond='data:view.isMultipleItems'> 
          <b:section class='head-text' id='head-text1' maxwidgets='1' name='Headline Text 02' showaddelement='no'>
             <b:widget id='Text1' locked='true' title='My Portfolio' type='Text' version='2' visible='true'>
               <b:widget-settings>
                 <b:widget-setting name='content'/>
               </b:widget-settings>
               <b:includable id='main'>
        ...
        <b:section class='main' id='main' maxwidgets='1' name='Main Posts' showaddelement='yes'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='style.urlcolor'>#888888</b:widget-setting>
              <b:widget-setting name='showAuthor'>true</b:widget-setting>
              <b:widget-setting name='style.linkcolor'>#7163cf</b:widget-setting>
...
<b:include data='post' name='postAuthor'/>
            ...
            <b:includable id='indexPost' var='post'>
              <!-- Index Post Content -->
<b:include data='post' name='postFeaturedThumb'/>
            </b:includable>
  ...
  <a expr:class='&quot;goog-inline-block sharing-&quot; + data:platform.key' expr:data-url='data:originalUrl' expr:href='data:shareUrl + &quot;&amp;target=&quot; + data:platform.target' expr:onclick='data:onclick ? data:onclick : &quot;&quot;' expr:title='data:platform.shareMessage' target='_blank'>
    <span class='share-button-link-text'>
      <data:platform.shareMessage/>
            ...
            <b:includable id='postFeaturedThumb' var='post'>
              <!-- Post Featured Image on Index -->
            <div class='post-image-wrap'>
                 <a class='post-image-link' expr:href='data:post.url'>
                    <b:if cond='data:post.featuredImage'> 
...
<div class='sliding-post-cat'>
  <b:include data='post' name='postJumpLink'/>

                        </div>
<div class='sliding-post-title'>
                       <h2 class='post-title'>
                         <i class='fa fa-dot-circle-o'/><span><data:post.title/></span>
                        </h2>
...
<b:include cond='data:allBylineItems.backlinks' data='post' name='postRelated'/>
            ...
            <b:if cond='data:blog.jumpLinkMessage != &quot;hide&quot;'>
              <i class='fa fa-eye'/><span><data:blog.jumpLinkMessage/></span>
              </b:if>
            </b:includable>
 ...
 &quot;publisher&quot;: {
    ...
    <b:loop values='data:posts filter (p =&gt; p.id != data:view.postId)' var='post'>
      <article class='post' role='article'>
        <b:include name='snippetedPostContent'/>
          ...
          <b:widget id='HTML7' locked='false' title='Technology' type='HTML' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML2' locked='false' title='Subscribe Us' type='HTML' visible='false'>
            <b:widget-settings>
...
&lt;/style&gt;</b:widget-setting>
    ...
    <span class='label-size'>
      ...
      <ul>
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='Label2' locked='false' title='Tags' type='Label' version='2' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
  ...
  <a class='profile-link' expr:href='data:userUrl' rel='author nofollow'>
    <data:messages.viewMyCompleteProfile/>
          ...
          <b:widget id='FeaturedPost1' locked='false' title='' type='FeaturedPost' version='2' visible='false'>
            <b:widget-settings>
    ...
    <b:loop values='data:posts filter (p =&gt; p.id != data:view.postId)' var='post'>
      <article class='post' role='article'>
        <b:include name='snippetedPostContent'/>
          ...
          <b:widget id='HTML71' locked='false' title='Slider Widget' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'>5/recent/slider</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='BlogSearch1' locked='false' title='Search This Blog' type='BlogSearch' visible='false'>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
  ...
  <input class='search-action' expr:value='data:messages.search.escaped' type='submit'/>
          ...
          <b:widget id='AdSense1' locked='false' title='' type='AdSense' version='2' visible='false'>
            <b:includable id='main'>
  <div class='widget-content'>
    ...
    <b:loop values='data:posts' var='post'>
      <li>
        <a expr:href='data:post.url'><data:post.title/></a>
          ...
          <b:widget id='AdSense2' locked='false' title='' type='AdSense' version='2' visible='false'>
            <b:includable id='main'>
  <div class='widget-content'>
    <b:if cond='data:adCode'>
      <data:adCode/>
  ...
  <script>
   (adsbygoogle = window.adsbygoogle || []).push({});
          ...
          <b:widget id='PageList1' locked='false' title='' type='PageList' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'https://ramanihiteshc.blogspot.com/', 'title': 'Home', 'position': 0}, '2959118125641988765': {'href': 'https://ramanihiteshc.blogspot.com/p/my-ios-applications.html', 'title': 'My Certificates', 'position': 1}}]]></b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML3' locked='false' title='Recent in Fashion' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'>3/Fashion/post-list</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML6' locked='false' title='Facebook' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<center><div class="fb-page" data-href="https://www.facebook.com/omtemplates" data-width="360" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div></center>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
...
&lt;/style&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='LinkList75' locked='false' title='Social Plugin' type='LinkList' visible='false'>
            <b:widget-settings>
              ...
              <b:widget-setting name='text-7'>rss</b:widget-setting>
              <b:widget-setting name='text-6'>youtube</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-0'>https://www.facebook.com/profile.php?id=100006464759261</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
...
<div id='map'>
  ...
  <iframe allowfullscreen='' aria-hidden='false' frameborder='0' height='450' src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3718.4525866041295!2d72.84022481493642!3d21.253545285876957!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be0491e8ce1a8ab%3A0xac63b47f86284c16!2sHCR%20Software%20Solution!5e0!3m2!1sen!2sin!4v1606456756806!5m2!1sen!2sin' style='border:0;' tabindex='0' width='600'/>
 ...
 <div class='clearfix'/>
  ...
  <div id='footer-wrapper'>
    <div id='contact-area'>
      <div class='container row'>
        <b:section class='contact-col top-bar-social social' id='contact-left' maxwidgets='2' name='Contact Left' showaddelement='no'>
          ...
          <b:widget id='LinkList2' locked='true' title='Contact List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='text-1'>github.com/Ramani1994</b:widget-setting>
              <b:widget-setting name='link-1'>https://github.com/Ramani1994</b:widget-setting>
              <b:widget-setting name='text-0'>Skype:ramanihiteshc </b:widget-setting>
              <b:widget-setting name='link-2'>fa-whatsapp</b:widget-setting>
              <b:widget-setting name='link-0'>fa-skype</b:widget-setting>
              <b:widget-setting name='text-2'>WhatsApp: +91 82384 19018</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
              <b:include name='widget-title'/>
              <b:include name='content'/>
          ...
          <b:widget id='LinkList73' locked='true' title='Social Widget' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://in.pinterest.com/ramanihitesh/</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='text-1'>twitter</b:widget-setting>
              <b:widget-setting name='link-1'>https://twitter.com/ramanihiteshc?lang=en</b:widget-setting>
              <b:widget-setting name='text-0'>facebook</b:widget-setting>
              <b:widget-setting name='link-2'>https://www.instagram.com/ramanihites/</b:widget-setting>
  ...
  <div class='clearfix'/>
    ...
    <div id='footer-copyright'>
      <div class='container row'>
        ...
        <div class='copyright-area'>Created By <a href='http://ramanihiteshc.blogspot.com/' id='mycontent' rel='dofollow' title='Ramani Hitesh'>Ramani Hitesh</a> | Distributed By <a href='https://hcrsoftware.blogspot.com/' rel='dofollow' style='color:#ff00ba;' target='_blank' title='Gooyaabi Templates'>HCR Software</a>
     </div>
        </div>
      </div>
...
<script type='text/javascript'>
//<![CDATA[
// typed.js - A JavaScript Typing Animation Library https://github.com/mattboldt/typed.js
